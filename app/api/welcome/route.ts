...
export async function POST(req: NextRequest) {
  try {
        ...
        <body style="background-color: #fcfcfc; margin: 0; padding: 0; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif;">
          <div style="max-width: 600px; margin: 0 auto; padding: 40px 20px;">
            ...
            <div style="text-align: center; margin-bottom: 30px;">
              <img
                src="https://offboardpro.vercel.app/logo.png"
                alt="OffboardPro"
                style="width: 160px; height: auto; outline: none; border: none; text-decoration: none;"
              >
            </div>
    ...
    console.log(
      `✅ Welcome email sent to ${email}. Resend ID: ${data?.id || "unknown"}`
    );
