    ...
    <div className="min-h-screen bg-white scroll-smooth relative font-sans selection:bg-[#9BCB3B] selection:text-white">
      ...
      <main className="overflow-x-clip">
        ...
        <section className="max-w-6xl mx-auto text-center pt-8 md:pt-24 pb-8 md:pb-12 px-6">
          ...
          >
            Never forget to remove <br className="hidden md:block" /> client access again.
          </h1>
            ...
            {!authLoading && (
              <div className="animate-in fade-in zoom-in-95 duration-700 flex flex-col items-center">
                <Link href={user ? "/dashboard" : "/signup"}>
                  <button 
                    style={{ backgroundColor: '#243F74' }} 
                    className="text-white px-10 md:px-14 py-4 md:py-5 rounded-full text-base md:text-lg font-bold hover:scale-105 transition-all shadow-xl shadow-[#243F74]/20 active:scale-95 group overflow-hidden relative"
                  >
        ...
        <Reveal>
        <div id="security" className="py-16 md:py-32 bg-slate-50/50 rounded-[3rem] md:rounded-[4rem] scroll-mt-24 text-left px-6 max-w-5xl mx-auto">
        ...
        {/* SECTION: FINAL CTA */}
        <Reveal>
        <section id="cta" style={{ backgroundColor: '#243F74' }} className="py-16 md:py-24 text-center text-white px-6 rounded-[3rem] md:rounded-[4rem] mt-12 md:mt-24 mb-12 md:mb-20 shadow-2xl shadow-[#243F74]/40 max-w-5xl mx-auto">
          ...
          {!authLoading && (
            <div className="animate-in fade-in zoom-in-95 duration-700">
              <Link href={user ? "/dashboard" : "/signup"}>
                <button 
                  style={{ backgroundColor: '#9BCB3B' }} 
                  className="w-full sm:w-auto text-white px-10 md:px-14 py-4 md:py-5 rounded-full text-base md:text-lg font-black hover:scale-105 transition-all shadow-2xl shadow-[#9BCB3B]/30 active:scale-95"
                >
