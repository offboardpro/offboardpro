...
function Kicker({
  ...
  return (
    <p className="text-xs md:text-sm font-black uppercase tracking-[0.25em] mb-3 md:mb-4 text-center italic text-[#9BCB3B]">
      {children}
    </p>
  );
}
  ...
  return (
    <div className="border-b border-slate-100 py-4 md:py-6 transition-all">
      ...
      >
        <span
          style={{ color: "#243F74" }}
          className="text-base sm:text-lg font-black leading-relaxed italic group-hover:text-[#9BCB3B] transition-colors"
        >
          {question}
        </span>
        <span
              ...
              <div className="relative flex items-center overflow-hidden [mask-image:linear-gradient(to_right,transparent,white_15%,white_85%,transparent)]">
                <div className="animate-marquee whitespace-nowrap flex items-center gap-8 sm:gap-12 md:gap-24">
                  {[
                    ...
                    <span
                      key={i}
                      className="text-[#243F74]/15 text-3xl sm:text-4xl md:text-7xl font-black italic tracking-tighter transition-colors duration-300 cursor-default hover:text-[#9BCB3B]/40 hover:scale-105 inline-block"
                    >
                      {item}
                    </span>
                  ))}
        ...
        <Reveal>
          <div className="py-14 sm:py-16 md:py-24 lg:py-28 px-4 sm:px-6 text-left">
            <div className="w-full max-w-6xl mx-auto">
              ...
              <h2
                style={{ color: "#243F74" }}
                className="text-3xl sm:text-4xl md:text-5xl font-black tracking-tight mb-12 md:mb-16 text-center italic"
              >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6 md:gap-8 mb-12">
                {[
                  ...
                  <RevealItem key={role.title} delay={i * 70}>
                    <div className="bg-slate-50 border border-slate-100 p-6 sm:p-8 rounded-[2rem] flex flex-col justify-between h-full hover:border-[#9BCB3B]/30 hover:bg-white hover:shadow-xl transition-all duration-300">
                      <h3 className="text-[#243F74] font-black text-lg sm:text-xl mb-2 italic">
                        {role.title}
                      </h3>
          ...
          <div className="py-14 sm:py-16 md:py-24 lg:py-28 px-4 sm:px-6 text-left">
            <div className="w-full max-w-6xl mx-auto">
              <div className="bg-slate-900 text-white p-5 sm:p-6 md:p-8 rounded-[2rem] shadow-2xl relative overflow-hidden">
                ...
                <h2 className="relative text-3xl sm:text-4xl md:text-5xl font-black text-[#9BCB3B] mb-4 italic text-center md:text-left leading-tight">
                ...
                <div className="relative grid grid-cols-1 md:grid-cols-3 gap-5 sm:gap-6 md:gap-8 mb-12">
                  {[
                    ...
                    <RevealItem key={card.t} delay={idx * 100}>
                      <div className="bg-white/5 p-5 sm:p-6 md:p-8 rounded-[2rem] border border-white/10 h-full hover:bg-white/10 hover:border-[#9BCB3B]/30 hover:-translate-y-1 transition-all duration-300">
                ...
                <div className="bg-[#9BCB3B]/10 border border-[#9BCB3B]/20 p-5 sm:p-6 md:p-8 rounded-[2rem] text-center md:text-left">
        ...
        <Reveal>
          ...
          >
            <div className="w-full max-w-6xl mx-auto">
              ...
              <h2
                style={{ color: "#243F74" }}
                className="text-3xl sm:text-4xl md:text-5xl font-black tracking-tight mb-4 text-center italic"
              >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 sm:gap-6 mb-16">
                {[
                  ...
                  <RevealItem key={step.n} delay={idx * 100}>
                    <div className="bg-white p-5 sm:p-6 md:p-8 rounded-[2rem] border border-slate-100 hover:border-[#9BCB3B]/30 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 group flex flex-col justify-between h-full">
                      <div>
                        <span
                          style={{ backgroundColor: "#9BCB3B" }}
                        ...
                        <h3
                          style={{ color: "#243F74" }}
                          className="text-lg sm:text-xl font-black mb-3 italic"
                        >
                          {step.t}
                        </h3>
                        <p className="text-slate-500 text-sm leading-relaxed font-medium">
              ...
              <div className="bg-slate-50 border border-slate-100 rounded-3xl p-6 md:p-8 text-center max-w-4xl mx-auto">
                ...
                <div className="flex flex-col sm:flex-row flex-wrap items-center justify-center gap-2 sm:gap-3 text-xs md:text-sm font-bold text-[#243F74]">
                  <span className="bg-white px-3 py-1.5 rounded-xl border border-slate-200 hover:border-[#9BCB3B]/50 hover:-translate-y-0.5 transition-all duration-200 cursor-default">
                    ADD CLIENT
                  </span>

                  <span className="text-[#9BCB3B] text-base sm:hidden">↓</span>
                  <span className="text-[#9BCB3B] hidden sm:inline">→</span>
                  ...
                  <span className="bg-[#243F74] text-white px-3 py-1.5 rounded-xl hover:-translate-y-0.5 transition-transform duration-200 cursor-default">
                    CLOSE PROJECT
                  </span>
                </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6 md:gap-8">
                {[
                  ...
                  <RevealItem key={feat.t} delay={idx * 90}>
                    <div className="bg-white p-5 sm:p-6 md:p-8 rounded-[2rem] border border-slate-100 hover:border-[#9BCB3B]/30 hover:shadow-xl hover:-translate-y-1.5 transition-all duration-300 flex flex-col justify-between h-full">
                      <div>
          ...
          <section className="py-14 sm:py-16 md:py-24 lg:py-28 px-4 sm:px-6 text-left">
            <div className="w-full max-w-6xl mx-auto">
              <div className="bg-slate-900 text-white p-5 sm:p-6 md:p-8 rounded-[2rem] shadow-2xl relative overflow-hidden">
                ...
                <h2 className="relative text-[#9BCB3B] text-3xl sm:text-4xl md:text-5xl font-black mb-4 italic text-center md:text-left">
                ...
                <div className="relative grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5 sm:gap-6 mb-10">
                  {[
                    ...
                    <RevealItem key={callout} delay={i * 70}>
                      <div className="bg-white/5 border border-white/10 p-5 sm:p-6 md:p-8 rounded-[2rem] flex items-center gap-3 h-full hover:bg-white/10 hover:border-[#9BCB3B]/30 transition-all duration-300">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-6 md:gap-8 mb-10">
                {[
                  ...
                  <RevealItem key={tool.name} delay={idx * 120}>
                    <div className="bg-slate-50 border border-slate-100 p-6 sm:p-8 rounded-[2rem] h-full hover:border-[#9BCB3B]/30 hover:bg-white hover:shadow-xl transition-all duration-300">
                ...
                <div className="relative grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5 sm:gap-6">
                  {[
                    ...
                    <RevealItem key={row.task} delay={idx * 100}>
                      <div className="bg-white/10 p-5 sm:p-6 md:p-8 rounded-[2rem] border border-white/10 h-full hover:bg-white/20 hover:border-[#9BCB3B]/40 transition-all duration-300">
            ...
            <div className="w-full max-w-6xl mx-auto">
              ...
              <div className="bg-slate-50 border border-slate-100 rounded-3xl p-6 md:p-8 text-center">
                ...
                <div className="flex flex-col sm:flex-row flex-wrap items-center justify-center gap-3 sm:gap-4 md:gap-6">
                  <div className="w-full sm:w-auto text-center bg-white px-4 py-2.5 rounded-xl border border-slate-200 text-xs sm:text-sm font-bold text-[#243F74]">
                    30 days before
                  </div>
                  <span className="text-[#9BCB3B] text-base sm:hidden">↓</span>
                  <span className="text-[#9BCB3B] hidden sm:inline font-black">→</span>
                  ...
                  <div className="w-full sm:w-auto text-center bg-[#9BCB3B] text-white px-4 py-2.5 rounded-xl text-xs sm:text-sm font-black">
                    Deadline
                  </div>
                  <span className="text-[#9BCB3B] text-base sm:hidden">↓</span>
                  <span className="text-[#9BCB3B] hidden sm:inline font-black">→</span>
        ...
        <Reveal>
          ...
          >
            <div className="w-full max-w-6xl mx-auto">
              ...
              <h2
                style={{ color: "#243F74" }}
                className="text-3xl sm:text-4xl md:text-5xl font-black tracking-tight mb-12 text-center italic"
              >
          ...
          >
            <div className="w-full max-w-6xl mx-auto">
              ...
              <div className="text-center mb-10 sm:mb-14 md:mb-16">
                <h2
                  style={{ color: "#243F74" }}
                  className="text-3xl sm:text-4xl md:text-5xl font-black tracking-tight mb-4 italic leading-tight"
                >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 max-w-5xl mx-auto">
                  ...
                  {!authLoading && (
                    <div className="mt-auto">
                      <Link
                        ...
                        className="block w-full py-4 sm:py-5 rounded-2xl border-2 border-slate-200 text-[#243F74] font-black hover:bg-slate-50 transition-all text-center uppercase text-xs tracking-[0.15em]"
                      >
                ...
                {/* PRO */}
                <div className="bg-white border-2 border-[#9BCB3B] rounded-[2rem] sm:rounded-[2.5rem] p-6 sm:p-8 md:p-10 lg:p-12 flex flex-col shadow-xl shadow-[#9BCB3B]/10 relative overflow-hidden">

                  <div className="absolute top-0 right-0 px-5 sm:px-6 py-2 bg-[#9BCB3B] text-white text-[10px] font-black uppercase rounded-bl-2xl tracking-widest">
                    Pro
                  </div>

                  <div className="mb-6">
                    <p className="text-[#243F74] font-black uppercase text-xs tracking-[0.2em] mb-3">
                      Pro
                    </p>
                  ...
                  <p className="text-[10px] font-black uppercase tracking-[0.2em] text-[#243F74] mb-4">
                  ...
                  {!authLoading && (
                    <div className="mt-auto">
                      <Link
                        ...
                        className="block w-full py-4 sm:py-5 rounded-2xl bg-[#243F74] text-white font-black hover:bg-[#1d335e] transition-all text-center uppercase text-xs tracking-[0.15em] shadow-lg"
                      >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 sm:gap-6 mb-10">
                {[
                  ...
                  <RevealItem key={s.step} delay={idx * 90}>
                    <div className="bg-slate-50 p-6 sm:p-8 rounded-[2rem] border border-slate-100 h-full hover:border-[#9BCB3B]/30 hover:bg-white hover:shadow-lg transition-all duration-300">
                      <span className="text-xs font-black uppercase text-[#9BCB3B] tracking-widest block mb-2">{s.step}</span>
                      <h3 className="font-black text-[#243F74] text-base sm:text-lg mb-2 italic">{s.t}</h3>
        ...
        <Reveal>
          <section id="faq" className="py-14 sm:py-16 md:py-24 lg:py-28 px-4 sm:px-6 scroll-mt-24 text-left">
            <div className="w-full max-w-3xl mx-auto">
              ...
              <h2
                style={{ color: "#243F74" }}
                className="text-3xl sm:text-4xl md:text-5xl font-black tracking-tight mb-10 md:mb-16 text-center italic"
              >
        ...
        <Reveal>
          <section className="py-14 sm:py-16 md:py-24 lg:py-28 px-4 sm:px-6">
            <div
              id="cta"
              style={{ backgroundColor: "#243F74" }}
              className="w-full max-w-6xl mx-auto relative overflow-hidden py-14 sm:py-16 md:py-20 text-center text-white px-6 rounded-[2.5rem] md:rounded-[3.5rem] shadow-2xl shadow-[#243F74]/40"
            >
              <div
                aria-hidden="true"
      ...
      <div className="relative min-h-[115vh] sm:min-h-[145vh] lg:min-h-[175vh]">
        ...
        <div className="sticky top-0 min-h-screen w-full flex items-center overflow-hidden">
          ...
          <div className="absolute inset-0 pointer-events-none overflow-hidden">
            ...
            <div
              className="absolute rounded-full blur-3xl bg-[#9BCB3B]/10
            ...
            <div
              className="absolute rounded-full blur-3xl bg-[#243F74]/5
          ...
          <div className="relative w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-10 md:py-12">
            ...
            <div className="text-center mb-7 sm:mb-10 md:mb-12">
              ...
              <p className="text-[#9BCB3B] text-[9px] sm:text-[10px] md:text-xs font-black tracking-[0.22em] sm:tracking-[0.25em] mb-3 sm:mb-4">
                THE OFFBOARDPRO WORKFLOW
              </p>

              <h2
                style={{ color: "#243F74" }}
                className="text-[2rem] leading-[1.05] sm:text-4xl md:text-5xl lg:text-6xl font-black tracking-tight italic"
              >
            ...
            <div className="relative w-full max-w-5xl mx-auto">
                ...
                <div className="w-40 xl:w-44 bg-white border border-slate-100 rounded-2xl shadow-xl px-4 py-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="w-9 h-9 rounded-xl bg-slate-50 flex items-center justify-center shrink-0">
                      <span className="text-[10px] font-black text-[#243F74]">
                        GH
                      </span>
                    </div>
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="text-xs font-black text-[#243F74]">
                        GitHub
                      </p>
                ...
                >
                  ...
                  <div className="h-11 sm:h-12 md:h-14 px-4 sm:px-6 md:px-8 border-b border-slate-100 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-1.5">
                      ...
                      <div className="w-2 h-2 sm:w-2.5 sm:h-2.5 rounded-full bg-[#9BCB3B]" />
                  ...
                  <div className="p-4 sm:p-6 md:p-8 lg:p-10 xl:p-12">
                    ...
                    <div className="flex flex-col xs:flex-row xs:items-center justify-between gap-4 sm:gap-5 mb-6 sm:mb-8">
                      ...
                      <div className="min-w-0">
                        ...
                        <h3
                          style={{ color: "#243F74" }}
                          className="text-xl sm:text-2xl md:text-3xl font-black tracking-tight truncate"
                        >
                          Acme Digital
                        </h3>
                      ...
                      <div
                        className={`self-start xs:self-auto px-3 sm:px-4 py-1.5 sm:py-2 rounded-full text-[8px] sm:text-[9px] md:text-[10px] font-black tracking-widest shrink-0 ${
                          stage === 4
                            ? "bg-[#243F74] text-white"
                    ...
                    <div className="mb-6 sm:mb-8 md:mb-10">
                      ...
                      <div className="h-2 sm:h-2.5 md:h-3 bg-slate-100 rounded-full overflow-hidden">
                        ...
                        <div
                          className="h-full bg-[#9BCB3B] rounded-full transition-all duration-700 ease-out"
                          style={{
                            width: `${Math.max(
                              progressPercentage,
                              stage === 0 ? 3 : 0
                    ...
                    >
                      ...
                      <div
                        className={`mx-auto w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 rounded-full flex items-center justify-center mb-2 sm:mb-3 transition-all duration-700 ${
                          stage === 4
                            ? "bg-[#9BCB3B] text-white scale-100"
              ...
              <div className="flex sm:hidden justify-center mt-5">
                ...
                <div className="bg-white border border-slate-100 shadow-lg rounded-full px-4 py-2 flex items-center gap-2 max-w-full">
                  ...
                  <div className="w-2 h-2 rounded-full bg-[#9BCB3B] animate-pulse shrink-0" />

                  <span className="text-[8px] font-black text-[#243F74] tracking-[0.12em] truncate">
