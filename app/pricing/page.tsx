            ...
            <div className="space-y-3">
              ...
              {!isPro ? (
                ...
                >
                  ...
                  {user ? "Upgrade to Pro Now" : "Get Started Now"}
                </button>
              ) : (
                <div className="flex flex-col gap-3">
                   <div className="w-full py-5 rounded-2xl bg-[#9BCB3B]/10 text-[#9BCB3B] border border-[#9BCB3B]/20 text-center font-black text-xs uppercase tracking-widest italic flex items-center justify-center gap-2">
